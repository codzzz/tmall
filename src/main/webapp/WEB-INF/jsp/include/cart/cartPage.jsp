			...
			<tbody>
				<c:forEach items="${ois}" var="oi">
					<tr oiid="${oi.id}" class="cartProductItemTR">
						<td>
							<img src="img/site/cartNotSelected.png" selectit="false" oiid="${oi.id}" class="cartProductItemIfSelected">
							<a style="display:none" href="#nowhere"><img src="img/site/cartSelected.png"></a>
							<img class="cartProductImg" src="img/productSingle_middle/${oi.product.pImage.id}.jpg">
						</td>
						<td>
