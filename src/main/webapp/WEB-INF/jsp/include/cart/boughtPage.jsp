				...
				<c:forEach items="${o.orderItems}" var="oi" varStatus="st">
					<tr class="orderItemProductInfoPartTR">
						<td class="orderItemProductInfoPartTD">
							<img alt="" src="img/productSingle_middle/${oi.product.pImage.id}.jpg" width="80" height="80">
						</td>
						<td class="orderItemProductInfoPartTD">
						...
						<c:if test="${st.count==1}">
							...
							<td valign="top" rowspan="${fn:length(o.orderItems)}" width="120px" class="orderListItemProductRealPriceTD orderItemOrderInfoPartTD">
							 	<div class="orderListItemProductRealPrice">￥<fmt:formatNumber type="number" value="${o.total}" minFractionDigits="2" maxFractionDigits="2"/></div>
