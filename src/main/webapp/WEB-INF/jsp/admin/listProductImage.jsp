...
<div class="workingArea">
	<ol class="breadcrumb">
		...
		<li><a href="admin_list_product?${p.cid}">${p.category.name}</a></li>
						...
						<div class="panel-body">
							<form action="admin_productImage_add" method="post" class="addFormSingle" enctype="multipart/form-data">
								<table class="addTable">
									...
									<tr>
										<td><input type="file" id="filepathSingle" name="image"></td>
									</tr>
									<tr class="submitTR">
										<td align="center">
						...
						<tbody>
							<c:forEach items="${pisSingle}" var="pi">
								<tr>
									...
									<td><a deleteLink="true" href="admin_productImage_delete?piid=${pi.id}"><span class="glyphicon glyphicon-trash"></span></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
						...
						<div class="panel-body">
							<form action="admin_productImage_add" method="post" class="addFormDetail" enctype="multipart/form-data">
								<table class="addTable">
									...
									<tr>
										<td>
											<input type="file" id="filepathDetail" name="image">
										</td>
									</tr>
									<tr class="submitTR">
										<td align="center">
